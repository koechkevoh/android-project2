...
set CLASSPATH=%APP_HOME%\lib\akka-quickstart-java.jar;%APP_HOME%\lib\akka-actor_2.12-2.5.22.jar;%APP_HOME%\lib\scala-java8-compat_2.12-0.8.0.jar;%APP_HOME%\lib\scala-library-2.12.8.jar;%APP_HOME%\lib\config-1.3.3.jar
